...
dat_import <- readRDS('../output_data/features_final_1105.rds') 
dat_import <- dat_import[, c(1:39, 41:44, 40)]
...
source("../source/function_headers.r")
...
# Tuned model with selected features 
predictions_list <- list(predictions_all_features)
